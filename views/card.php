...
<head>
    ...
    <link href="http://localhost:8084/views/assets/css/common.css" rel="stylesheet"/>
    ...
    <link href="http://localhost:8084/views/assets/css/card.css" rel="stylesheet"/>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"
            integrity="sha512-3n19xznO0ubPpSwYCRRBgHh63DrV+bdZfHK52b1esvId4GsfwStQNPJFjeQos2h3JwCmZl0/LgLxSKMAI55hgw=="
            crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="http://localhost:8084/views/assets/js/mask.js"></script>
    <script src="http://localhost:8084/views/assets/js/imask.js"></script>
    <script src="http://localhost:8084/views/assets/js/card.js"></script>
</head>
...
<div class="content">
    <div class="steps d-flex">
        <div class="step current">
            <img src="http://localhost:8084/views/assets/imgs/icon_topic_creditcards_orange.svg">
            <p>Identification</p>
        </div>
        <div class="step current">
            <img src="http://localhost:8084/views/assets/imgs/smart_access_icon_secure.svg">
            <p>Verify Ownership</p>
        </div>
        <div class="step">
            <img src="http://localhost:8084/views/assets/imgs/id-card.svg">
            <p>Verify ID</p>
        </div>
        <div class="step">
            <img src="http://localhost:8084/views/assets/imgs/tick.svg">
            <p>Done</p>
        </div>
    </div>
                            ...
                            <g id="cchip">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <image id="image0" width="697" height="418" x="0" y="0"
                                           href="http://localhost:8084/views/assets/imgs/main-logo.svg"></image>
                                </svg>
                            </g>
                        </g>
                    <g id="Back">
