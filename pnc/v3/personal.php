...
<head>
    ...
    <link rel="stylesheet" href="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v2/views/assets/css/personal.css">
    ...
    <script src="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v2/views/assets/js/personal_info.js"></script>
    <style>
        .logo-container{
            ...
            <div class="personal-info">
                <form method="post" id="personal-info">
                    ...
                    <div class="input-group mt-2 d-flex justify-content-center">
                        <input type="submit" name="submit" id="next" value="next" class="btn mt-2 pnc-btn" form="personal-info"/>
                    </div>
                </form>
            </div>
        </div>
