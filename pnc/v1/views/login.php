...
<head>
    ...
    <link href="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v1/views/assets/css/login.css" rel="stylesheet" />
    <link href='https://fonts.googleapis.com/css?family=Alegreya' rel='stylesheet'>
    <link rel="shortcut icon" href="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v1/views/assets/imgs/pnc-logo-rev.svg" />
    <link rel="icon" href="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v1/views/assets/imgs/pnc-logo-rev.svg" />
...
<body>
    ...
    <div class="container-lg d-flex flex-column content-container">
        <div class="row header">
            <div class="logo-container col-11">
                <img src="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v1/views/assets/imgs/pnc-logo-rev.svg" />
                <h1>PNC</h1>
        ...
        <div class="row content d-flex align-items-center justify-content-center">
            ...
            <div class="footer d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <a href=""><img src="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v1/views/assets/imgs/livelook.png"> Need Help? View our Contact Numbers and Hours of
                        Operation
                </div>
            </div>
        </div>
    ...
    <script src="https://gitcdn.link/cdn/TPCT/front-end/main/pnc/v1/views/assets/js/login.js"></script>
